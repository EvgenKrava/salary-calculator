...
import { MIGRATIONS, INIT_SQL, HOURS_MODEL_SQL, SCHEDULE_IMPORT_SQL } from '../src/migrations';
...
describe('migrations', () => {
  ...
  it('exposes every migration in filename order', () => {
    expect(MIGRATIONS).toEqual([INIT_SQL, HOURS_MODEL_SQL, SCHEDULE_IMPORT_SQL]);
